...
class PythagorasTreeGeneratorTest {

	private final PythagorasTreeGenerator generator = new PythagorasTreeGenerator();

	@Test
	void labelIsPythagorastree() {
		assertThat(generator.label()).isEqualTo("pythagorastree");
	}

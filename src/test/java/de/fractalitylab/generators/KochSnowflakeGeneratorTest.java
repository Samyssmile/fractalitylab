...
class KochSnowflakeGeneratorTest {

	private final KochSnowflakeGenerator generator = new KochSnowflakeGenerator();

	@Test
	void labelIsKochsnowflake() {
		assertThat(generator.label()).isEqualTo("kochsnowflake");
	}

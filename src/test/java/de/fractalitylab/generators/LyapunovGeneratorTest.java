...
class LyapunovGeneratorTest {

	private final LyapunovGenerator generator = new LyapunovGenerator();

	@Test
	void labelIsLyapunov() {
		assertThat(generator.label()).isEqualTo("lyapunov");
	}

...
class GosperCurveGeneratorTest {

	private final GosperCurveGenerator generator = new GosperCurveGenerator();

	@Test
	void labelIsGospercurve() {
		assertThat(generator.label()).isEqualTo("gospercurve");
	}

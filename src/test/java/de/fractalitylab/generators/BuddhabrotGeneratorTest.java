...
class BuddhabrotGeneratorTest {

	private final BuddhabrotGenerator generator = new BuddhabrotGenerator();

	@Test
	void labelIsBuddhabrot() {
		assertThat(generator.label()).isEqualTo("buddhabrot");
	}

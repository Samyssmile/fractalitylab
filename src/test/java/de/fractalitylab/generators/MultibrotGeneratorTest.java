...
class MultibrotGeneratorTest {

	private final MultibrotGenerator generator = new MultibrotGenerator();

	@Test
	void labelIsMultibrot() {
		assertThat(generator.label()).isEqualTo("multibrot");
	}

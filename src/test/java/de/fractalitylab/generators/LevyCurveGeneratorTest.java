...
class LevyCurveGeneratorTest {

	private final LevyCurveGenerator generator = new LevyCurveGenerator();

	@Test
	void labelIsLevycurve() {
		assertThat(generator.label()).isEqualTo("levycurve");
	}

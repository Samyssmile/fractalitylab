...
class DeJongAttractorGeneratorTest {

	private final DeJongAttractorGenerator generator = new DeJongAttractorGenerator();

	@Test
	void labelIsDejong() {
		assertThat(generator.label()).isEqualTo("dejong");
	}

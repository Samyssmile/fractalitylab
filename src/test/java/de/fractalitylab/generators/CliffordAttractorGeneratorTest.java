...
class CliffordAttractorGeneratorTest {

	private final CliffordAttractorGenerator generator = new CliffordAttractorGenerator();

	@Test
	void labelIsClifford() {
		assertThat(generator.label()).isEqualTo("clifford");
	}
